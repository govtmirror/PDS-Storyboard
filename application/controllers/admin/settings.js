...
var settingsController = {
    ...
    /**
     * Display disqus settings page.
     * @param {Object} req
     * @param {Object} res
     */
    disqus: function(req, res){
        res.locals.Breadcrumb = 'Disqus Settings';
        res.locals.BreadcrumbLink = '/admin/disqus-settings';
        res.locals.subBreadcrumb = 'Disqus';

        system
            .loadView(
                res,
                path.join('','admin/settings/disqus'),
                {title: 'Settings', data:{
                    DISQUS_SHORTNAME: global.DEFINES.DISQUS_SHORTNAME,
                    DISQUS_API_SECRET_KEY: global.DEFINES.DISQUS_API_SECRET_KEY,
                    DISQUS_API_PUBLIC_KEY: global.DEFINES.DISQUS_API_PUBLIC_KEY
                }}
        );
    },

    /**
     * Updates disqus settings.
     * @param {[[Type]]} req [[Description]]
     * @param {[[Type]]} res [[Description]]
     */
    updateDisqus: function(req, res){
        var params = req.body;
