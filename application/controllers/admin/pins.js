 ...
 * - modified addBoardPost function to save a thumb image when creating the category
 * - modified addCategoryPost function to save the creator field for the category
 *
 * @package cubetboard
 * @version 2.1
        ...
        form.parse(req, function(err, fields, files) {
            ...
            if(files.image.name && files.image.name != '') {
                fs.readFile(files.image.path, function(err, data) {
                    ...
                    var thumbPath = path.join('uploads/boards/thumb/', newimage);
    ...
    addCategoryPost: function(req, res){
        ...
        form.parse(req, function(err, fields, files) {
            var category = {
                ...
                "description": fields.desc,
                "timestamp": new Date().getTime(),
                "creator": req.session.admin_user_id
            };
