...
var urlfetchController = {
    ...
    addimg_loop: function(i, imagepinModel, req, res, callback) {
        ...
        var chkdbox_arr = req.body.img_chkbox instanceof Array ?
                          req.body.img_chkbox   :
                          [req.body.img_chkbox] ;
        var url_length = chkdbox_arr.length; // count of image urls array
        var img_url = chkdbox_arr[i];
...
//            img_url = img_url.replace('https://', 'http://');
        console.log('addimg_loop', i, img_url);
                                        ...
                                        im.resize(rez_opt, function(err, stdout, stderr) {
                                            ...
                                            if (i == (url_length - 1))
                                            {
                                                ...
                                                imagepinModel.insert(db_data, function(inserted_data) {
                                                    ...
                                                    var gridEl = system.getCompiledView(path.join('','pins/moredataGrid'), inserted_data[0]);
                                                    var listEl = system.getCompiledView(path.join('','pins/moredataList'), inserted_data[0]);
                                                    boardModel.getCategoryByBoardId(board_id,function(catdetails){
                                                        ...
                                                        boardModel.getBoardOne(board_id, function(boards){
                                                            ...
                                                            var story = {
                                                                ...
                                                                item_image: Array.isArray(inserted_data[0].image_name) ? inserted_data[0].image_name : inserted_data[0].image_name,
