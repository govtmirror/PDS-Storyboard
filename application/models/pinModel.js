 ...
 * - fixed bug related to wrong user links on most repinned/liked pages
 *
 * Changes in version 2.2
 * - fixed bug in related to pin like/unlike
 *
 * pin Model 
 * The MIT License (MIT)
 * @category: cubetboard
 * @package :pin
 * @version 2.2
 * @author Arya <arya@cubettech.com>, MonicaMuranyi, kiril.kartunov
 * @Date 20-11-2013
 */
            ...
            res.toArray(function(er, data) {
                ...
                if (data.length > 0) {
                    ...
                    data.forEach(function(v) {
                        ...
                        mongodb.collection('pin_like').find({
                            'pin_id': v._id
                            ...
                            if (res3) {
                                v.pinlikecount = res3.length;
                                res3.forEach(function(like){
                                    if(like.user_id.toHexString() == user_id){
                                        v.pinlike = 1;
                                    }
                                });
                            }
